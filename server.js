...
app.set('views', process.env['APP_PATH'] || __dirname + '/app/views');
app.set('view engine', 'ejs');
app.use(morgan('combined'))
app.use(express.static(process.env['APP_PATH'] || __dirname + "/app/dist"))
	.use(express.static( process.env['APP_PATH'] || __dirname + "/app/assets"))
	.use(favicon(process.env['APP_PATH'] || __dirname + '/app/assets/images/favicon.ico'))
	.get('/*', (req, res) => {

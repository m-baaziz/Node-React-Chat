...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxThunk = __webpack_require__(155);
	...
	var _routesReact = __webpack_require__(159);
	...
	var io = __webpack_require__(177).listen(server);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isTextInputElement = __webpack_require__(40);
	var keyOf = __webpack_require__(29);
...
/***/ function(module, exports) {
	...
	var SAFE_COLORS = ["#003366", "#0066cc", "#00cc00", "#3399cc", "#3300cc", "#336600", "#339966", "#33cccc", "#660000", "#663366", "#6666cc", "#66cc00", "#66cc99", "#9900cc", "#996600", "#999966", "#99cccc", "#cc0000", "#cc3366", "#cc66cc", "#cccc00", "#ccff66", "#ff00cc", "#ff6600", "#ff9966", "#ffcccc"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _usersActions = __webpack_require__(161);
	...
	var NAME_REGEXP = /^[A-Za-z\-\_0-9]+[A-Za-z \-\_0-9]*[A-Za-z\-\_0-9]+$/;
	...
	var App = function (_Component) {
		...
		function App(props, context) {
			...
			_this.onNameError = _this.onNameError.bind(_this);
			_this.state = { nameErrors: [] };
			return _this;
		}
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				...
				this.socket = io();
				this.socket.on('serverHandshake', function (myInfos) {
					var id = myInfos.id;
					var name = myInfos.name;
					var color = myInfos.color;
					var onlineUsers = myInfos.onlineUsers;

					dispatch((0, _usersActions.setCurrentUser)(id, name, color));
					if (!_lodash2.default.isEmpty(onlineUsers)) {
						_lodash2.default.forEach(onlineUsers, function (user) {
							var id = user.id;
							var name = user.name;
							var color = user.color;

							dispatch((0, _usersActions.addUser)(id, name, color));
						});
					}
				});
				this.socket.on('userConnection', function (user) {
					var id = user.id;
					var name = user.name;
					var color = user.color;
				...
				this.socket.on('userDisconnection', function (id) {
					dispatch((0, _usersActions.removeUser)(id));
				});
			}
		}, {
			key: 'onNameSubmit',
			...
			key: 'onNameError',
			value: function onNameError(errors) {
			...
			value: function renderChildren() {
				...
				if (typeof io != "undefined") {
					return _lodash2.default.map(_lodash2.default.compact(_lodash2.default.flatten([this.props.children])), function (child, key) {
						var newProps = Object.assign({}, child.props, { socket: _this2.socket });
						return Object.assign({}, child, { key: key, props: newProps });
					});
				}
			}
		}, {
			...
			value: function render() {
				...
				var nameErrors = this.state.nameErrors;


				var buildNewUserForm = function buildNewUserForm() {
					var liGroup = _lodash2.default.map(nameErrors, function (error, index) {
					...
					var errosDiv = _react2.default.createElement(
						'div',
					...
					return _react2.default.createElement(
						...
						_lodash2.default.isEmpty(nameErrors) ? null : errosDiv,
						_react2.default.createElement(_textInput2.default, { className: 'form-control', autoFocus: true, placeholder: 'Enter your name ...', onSubmit: _this3.onNameSubmit, check: _this3.checkName, onErrorOnSubmit: _this3.onNameError })
					);
				};
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'nav',
						{ id: 'title-header', className: 'navbar navbar-default navbar-static-top' },
						_react2.default.createElement(
							'div',
					...
					_lodash2.default.isEmpty(this.props.currentUser) ? buildNewUserForm() : this.renderChildren()
				);
			}
		}], [{
			key: 'fetchData',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		setCurrentUser: function setCurrentUser(id, name, color) {
			return {
				type: _constants.ActionTypes.SET_CURRENT_USER,
				id: id,
				name: name,
				color: color
			};
		},
		addUser: function addUser(id, name, color) {
			return {
				type: _constants.ActionTypes.ADD_USER,
				id: id,
				name: name,
				color: color
			};
		...
		removeUser: function removeUser(id) {
			return {
				type: _constants.ActionTypes.REMOVE_USER,
				id: id
			};
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextInput = function (_Component) {
		...
		function TextInput(props) {
			...
			_this.state = { value: null, isValid: false, errors: [] };
			return _this;
		}
		...
		_createClass(TextInput, [{
			...
			value: function onChange(e) {
				...
				var onErrorOnChange = _props.onErrorOnChange;
				var value = e.target.value;

				var errors = check ? check(value) : [];
				var isValid = _lodash2.default.isEmpty(errors);
				this.setState({ value: value, isValid: isValid, errors: errors });
			...
			value: function onSubmit(e) {
				...
				var onErrorOnSubmit = this.props.onErrorOnSubmit;
			...
			value: function render() {
				...
				var getFeedbackClass = function getFeedbackClass() {
					if (_lodash2.default.isEmpty(value)) return "glyphicon glyphicon-pencil form-control-feedback";
					return isValid ? "glyphicon glyphicon-ok form-control-feedback" : "glyphicon glyphicon-warning-sign form-control-feedback";
				};

				return _react2.default.createElement(
					'form',
					{ className: 'form-group has-feedback', onSubmit: onSubmit ? this.onSubmit : null },
					_react2.default.createElement('input', { className: className ? className : null, ref: ref, autoFocus: autoFocus, type: 'text', placeholder: placeholder, value: value, onChange: this.onChange }),
					_react2.default.createElement('span', { className: getFeedbackClass(), ariaHidden: 'true' })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _conversationsActions = __webpack_require__(167);

	var _constants = __webpack_require__(162);

	var _chat = __webpack_require__(168);

	var _chat2 = _interopRequireDefault(_chat);

	var _usersList = __webpack_require__(171);
	...
	var Home = function (_Component) {
		...
		function Home(props) {
			...
			_this.state = { currentInterlocutors: [] };
			return _this;
		}
		...
		_createClass(Home, [{
			...
			value: function receiveMessage(msg) {
				...
				this.props.dispatch((0, _conversationsActions.updateConversation)(emitter, receiver, content));
			}
		}, {
			key: 'sendMessage',
			value: function sendMessage(content) {
				...
				content['moment'] = (0, _moment2.default)().format(_constants.MOMENT_SERIALIZATION);
				_.forEach(this.state.currentInterlocutors, function (interlocutor) {
					var msg = { emitter: currentUser, receiver: interlocutor, content: content };
					socket.emit('message', msg);
					dispatch((0, _conversationsActions.updateConversation)(currentUser, interlocutor, content));
				});
			}
		}, {
			key: 'onUserClick',
			value: function onUserClick(user) {
				var interlocutors = [user];
				this.setState({ currentInterlocutors: interlocutors });
			}
		}, {
			key: 'render',
			value: function render() {
				var currentInterlocutors = this.state.currentInterlocutors;
				var _props2 = this.props;
				var conversations = _props2.conversations;
				var currentUser = _props2.currentUser;

				var matchingConversations = _.filter(conversations, function (conversation) {
					var receiverInInterlocutors = _.find(currentInterlocutors, function (interlocutor) {
						return interlocutor.id == conversation.receiver.id;
					});
					var emitterInInterlocutors = _.find(currentInterlocutors, function (interlocutor) {
						return interlocutor.id == conversation.emitter.id;
					});
					return conversation.emitter.id == currentUser.id && receiverInInterlocutors || conversation.receiver.id == currentUser.id && emitterInInterlocutors;
				});

				var messages = _.reduce(matchingConversations, function (current, conversation) {
					var tmpMessages = _.map(conversation.messages, function (msg) {
				...
				var usersIdSendingMessage = _.map(_.filter(conversations, function (conver) {
					return conver.receiver.id == currentUser.id && conver.messages.length > 0 && _.last(conver.messages).state == 'loading';
				}), function (conversation) {
					return conversation.emitter.id;
				});

				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_usersList2.default, { users: this.props.users, usersIdSendingMessage: usersIdSendingMessage, onClick: this.onUserClick }),
					!_.isEmpty(currentInterlocutors) ? _react2.default.createElement(_chat2.default, { sendMessage: this.sendMessage, messages: messages, emitterId: currentUser.id, interlocutors: currentInterlocutors }) : null
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		createConversation: function createConversation(emitter, receiver) {
			return {
				type: _constants.ActionTypes.CREATE_CONVERSATION,
				emitter: emitter,
				receiver: receiver
			};
		},
		updateConversation: function updateConversation(emitter, receiver, msg) {
			return {
				type: _constants.ActionTypes.UPDATE_CONVERSATION,
				emitter: emitter,
				receiver: receiver,
				msg: msg
			};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _letterIcon = __webpack_require__(169);

	var _letterIcon2 = _interopRequireDefault(_letterIcon);
	...
	if (typeof window != 'undefined') {
		var ScrollArea = __webpack_require__(170);
	}; // conditional import because of the server-side rendering
	...
	var Chat = function (_Component) {
		...
		function Chat(props) {
			...
			_this.sendMessage = _this.sendMessage.bind(_this);
			_this.onMsgChange = _this.onMsgChange.bind(_this);
			_this.onMsgKeyDown = _this.onMsgKeyDown.bind(_this);
			_this.state = { msgBuffer: null };
			return _this;
		}
		...
		_createClass(Chat, [{
			...
			value: function componentDidUpdate(prevProps) {
				...
				if (this.refs.scrollBar) setTimeout(function () {
					_this2.refs.scrollBar.scrollBottom();
				}, 0);
			}
		}, {
			key: 'componentWillReceiveProps',
			value: function componentWillReceiveProps(nextProps) {
				if (_lodash2.default.xor(nextProps.interlocutors, this.props.interlocutors).length > 0 && this.refs.chatTextArea) this.refs.chatTextArea.focus();
			}
		}, {
			key: 'onMsgChange',
			value: function onMsgChange(e) {
			...
			value: function sendMessage(e) {
				var msgBuffer = this.state.msgBuffer;

				if (!_lodash2.default.isEmpty(msgBuffer)) {
			...
			value: function render() {
				...
				var emitterId = _props.emitterId;
				var interlocutors = _props.interlocutors;


				var time = function time(msg) {
					return msg.moment.format("hh:mm");
				};

				var messageGroup = _lodash2.default.map(messages, function (msg, index) {
					if (msg.emitter.id != emitterId) if (msg.state == 'loading') {
						return _react2.default.createElement(
							'div',
							{ key: index, className: 'message loading new' },
							_react2.default.createElement(_letterIcon2.default, { className: 'pull-left', color: msg.emitter.color, letter: msg.emitter.name[0] }),
							_react2.default.createElement('span', null)
						);
					} else {
						return _react2.default.createElement(
							'div',
							{ key: index, className: 'message new' },
							_react2.default.createElement(_letterIcon2.default, { className: 'pull-left', color: msg.emitter.color, letter: msg.emitter.name[0] }),
							msg.body,
							_react2.default.createElement(
								'div',
								{ className: 'left-timestamp' },
								' ',
								time(msg),
								' '
							)
					...
					if (msg.emitter.id == emitterId && msg.state != "loading") return _react2.default.createElement(
						'div',
						{ key: index, className: 'message message-personal' },
						' ',
						msg.body,
						_react2.default.createElement(
							'div',
				...
				var head = _lodash2.default.map(interlocutors, function (interlocutor, index) {
					return _react2.default.createElement(
						'div',
						{ key: index },
						_react2.default.createElement(_letterIcon2.default, { className: 'pull-left', color: interlocutor.color, letter: interlocutor.name[0] }),
						_react2.default.createElement(
							'h1',
							null,
							' ',
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							typeof window == 'undefined' ? messageGroup : _react2.default.createElement(
								ScrollArea,
								{ ref: 'scrollBar', style: { height: this.refs.messages ? this.refs.messages.offsetHeight : '100%' } },
								messageGroup
							)
						)
					),
					_react2.default.createElement(
						'form',
						{ className: 'message-box', onSubmit: this.sendMessage },
						_react2.default.createElement('textarea', { type: 'text', className: 'message-input', placeholder: 'Type message...', ref: 'chatTextArea', autoFocus: true, value: msgBuffer, onChange: this.onMsgChange, onKeyDown: this.onMsgKeyDown }),
						_react2.default.createElement(
							'button',
							{ type: 'submit', className: 'message-submit' },
							'Send'
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LetterIcon = function (_Component) {
		_inherits(LetterIcon, _Component);

		function LetterIcon(props) {
			_classCallCheck(this, LetterIcon);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(LetterIcon).call(this, props));
		}

		_createClass(LetterIcon, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'span',
					{ className: 'letter-icon ' + this.props.className, style: { backgroundColor: this.props.color } },
					this.props.letter
				);
			}
		}]);
	...
	exports.default = LetterIcon;

/***/ },
/* 170 */
/***/ function(module, exports) {

	module.exports = require("react-scrollbar");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersList = function (_Component) {
		...
		function UsersList(props) {
			...
			_this.onSearchBarChange = _this.onSearchBarChange.bind(_this);
			_this.updateUsersList = _this.updateUsersList.bind(_this);
			_this.state = { search: null, users: props.users };
			return _this;
		}
		...
		_createClass(UsersList, [{
			...
			value: function onClick(e) {
				var user = this.state.users[e.currentTarget.value];
			...
			value: function updateUsersList() {
				...
				var matchingUsers = _lodash2.default.isEmpty(search) ? props.users : _lodash2.default.filter(props.users, function (user) {
					return _lodash2.default.includes(_lodash2.default.toLower(user.name), search);
				});
				this.setState({ users: matchingUsers });
			}
		}, {
			key: 'onSearchBarChange',
			value: function onSearchBarChange(e) {
				var _this2 = this;

				this.setState({ search: e.target.value }, function () {
					_this2.updateUsersList();
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				var listGroup = _lodash2.default.map(users, function (user, index) {
					return _react2.default.createElement(
						'li',
						{ key: index, value: index, onClick: _this3.onClick, className: 'list-group-item users-item' },
						_react2.default.createElement(_letterIcon2.default, { className: 'pull-left', color: user.color, letter: user.name[0] }),
						_react2.default.createElement(
							'span',
							{ className: 'user-name' },
							' ',
						...
						_lodash2.default.includes(_this3.props.usersIdSendingMessage, user.id) ? _react2.default.createElement(
							'div',
							{ className: 'user-msg-loading' },
							' ',
							_react2.default.createElement('span', null),
							' '
						) : null
				...
				var noUsers = _react2.default.createElement(
					'li',
					{ className: 'list-group-item no-users' },
					' No users '
				);
				var ulGroup = _react2.default.createElement(
					'ul',
					{ className: 'list-group' },
					_lodash2.default.isEmpty(listGroup) ? noUsers : listGroup
				);

				return _react2.default.createElement(
					'div',
					{ className: 'panel panel-default users-list', ref: 'usersList' },
					_react2.default.createElement(
						'div',
						{ className: 'panel-heading' },
						_react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Search users ...', value: search, onChange: this.onSearchBarChange })
					),
					_react2.default.createElement(
						'div',
						{ className: 'panel-body' },
						typeof window == 'undefined' ? ulGroup : _react2.default.createElement(
							ScrollArea,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _currentUser = __webpack_require__(174);
	...
	var _conversations = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function currentUser() {
		...
		switch (action.type) {
			case _constants.ActionTypes.SET_CURRENT_USER:
				var id = action.id;
				var name = action.name;
				var color = action.color;

				var user = { id: id, name: name, color: color };
				return user;
			default:
				return state;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function users() {
		...
		switch (action.type) {
			case _constants.ActionTypes.ADD_USER:
				{
					var _ret = function () {
						...
						var existingIndex = _.findIndex(state, function (u) {
							return u.id == id;
						});
						var user = { id: id, name: name, color: color };
						if (existingIndex != -1) {
			...
			case _constants.ActionTypes.REMOVE_USER:
				{
					var _newState = state.slice();
					_.remove(_newState, function (user) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function conversations() {
		...
		switch (action.type) {
			case _constants.ActionTypes.CREATE_CONVERSATION:
				{
					var emitter = action.emitter;
					var receiver = action.receiver;

					var conversation = { emitter: emitter, receiver: receiver, messages: [] };
					var newState = state.slice();
					newState.push(conversation);
					return newState;
				}
			case _constants.ActionTypes.UPDATE_CONVERSATION:
				{
					var _ret = function () {
						var emitter = action.emitter;
						var receiver = action.receiver;
						...
						msg['moment'] = (0, _moment2.default)(msg.moment, _constants.MOMENT_SERIALIZATION);
						var conversationIndex = _lodash2.default.findIndex(state, function (conver) {
							return conver.emitter.id == emitter.id && conver.receiver.id == receiver.id;
						});
						var newState = state.slice();
						var conversation = { emitter: emitter, receiver: receiver, messages: [msg] };
						if (conversationIndex < 0) {
							...
							if (!_lodash2.default.isEmpty(messages) && _lodash2.default.last(messages).state == 'loading') if (messages.length) messages = messages.slice(0, -1);
							if (msg.state != 'canceled') messages.push(msg);
